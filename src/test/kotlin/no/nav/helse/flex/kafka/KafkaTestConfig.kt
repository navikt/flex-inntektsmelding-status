...
class KafkaTestConfig(
    ...
    fun mockSchemaRegistryClient(): MockSchemaRegistryClient {
        ...
        // mockSchemaRegistryClient.register("$brukernotifikasjonBeskjedTopic-value", AvroSchema(NokkelInput.`SCHEMA$`))
        mockSchemaRegistryClient.register("$brukernotifikasjonBeskjedTopic-value", AvroSchema(BeskjedInput.`SCHEMA$`))
        mockSchemaRegistryClient.register("$brukernotifikasjonDoneTopic-value", AvroSchema(NokkelInput.`SCHEMA$`))
        mockSchemaRegistryClient.register("$brukernotifikasjonDoneTopic-value", AvroSchema(DoneInput.`SCHEMA$`))
