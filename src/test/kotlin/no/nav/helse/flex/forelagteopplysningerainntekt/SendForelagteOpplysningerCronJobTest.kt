...
class SendForelagteOpplysningerCronJobTest {
    ...
    fun `burde kalle på totaltAntallForelagteOpplysningerSjekk med alle forelagte opplysninger`() {
        val forelagteOpplysningerRepository: ForelagteOpplysningerRepository = mock {
            on { findAllByForelagtIsNull() } doReturn listOf(
        ...
        val sendForelagteOpplysningerCronjob = SendForelagteOpplysningerCronjob(
        ...
        verify(totaltAntallForelagteOpplysningerSjekk).sjekk(listOf(
            lagTestForelagteOpplysninger(id="1"),
            lagTestForelagteOpplysninger(id="2")
        ))
    }
...
private fun lagTestForelagteOpplysninger(id: String = "test-id", forelagt: Instant? = null): ForelagteOpplysningerDbRecord {
