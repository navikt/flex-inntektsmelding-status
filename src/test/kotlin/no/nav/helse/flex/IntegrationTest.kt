...
class IntegrationTest : FellesTestOppsett() {
    ...
    fun `Vi bestiller beskjed på ditt nav og melding på ditt sykefravær`() {
        ...
        beskjedInput.get("tekst") shouldBeEqualTo "Vi mangler opplysninger om inntekten din fra Flex AS for sykefraværet som startet 16. mai 2022."
        ...
        opprettMelding.tekst shouldBeEqualTo "Vi mangler opplysninger om inntekten din fra Flex AS for sykefraværet som startet 16. mai 2022."
    ...
    fun `Vi bestiller ditt sykefravær melding om mottatt inntektsmelding`() {
        ...
        opprettMelding.tekst shouldBeEqualTo "Vi har mottatt opplysninger om inntekten din fra Flex AS for sykefraværet som startet 16. mai 2022."
